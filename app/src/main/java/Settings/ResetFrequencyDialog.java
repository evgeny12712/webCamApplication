...
public class ResetFrequencyDialog extends AppCompatDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            builder.setView(view).setMessage("In which frequency you want to reset your clips? please choose with jumps of 5 minute's drive.")
